...
urlpatterns = [
    ...
    path('supplies/rental_list/', views.Rentallist.as_view(), name='rental-list'),
    path('supplies/lend_list/', views.Lendlist.as_view(), name="lend-supplies"),
    path('supplies/<int:pk>/rental_throw/', views.ThrowRentalView.as_view(), name='throw-rental'),
]
