...
urlpatterns = [
    ...
    path('supplies/create/', views.CreateSuppliesView.as_view(), name='create-supplies'), # 登録
    path('supplies/<int:pk>/update/', views.UpdateSuppliesView.as_view(), name='update-supplies'), # 更新
    path('supplies/<int:pk>/delete/', views.DeleteSuppliesView.as_view(), name='delete-supplies'), # 削除 
